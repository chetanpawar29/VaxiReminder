		...
		<div class="pd-ltr-20 xs-pd-20-10" >
			<div class="min-height-200px" >
				...
				<div class="pd-20 card-box mb-30" style="background: #fff">
					<div class="clearfix">
						<h4 class="text-blue h4">Change Contact No.</h4>
						
					</div>
					<div class="wizard-content">
						<form class="tab-wizard wizard-circle wizard" action="ChangeContNo" method="post">
							<h5>Child Id</h5>
							<section>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="cId" placeholder="Enter Child Id">
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="parentContact" placeholder="Enter New Parent Contact No">

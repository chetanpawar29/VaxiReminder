			...
			<div class="min-height-200px" >
				...
				<div class="pd-20 card-box mb-30" style="background: #fff">
					...
					<div class="wizard-content">
						<form class="tab-wizard wizard-circle wizard" action="AddVaccine" method="post">
							<h5>Vaccine Name</h5>
							<section>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="vaccineName" placeholder="Enter Vaccine Name">
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea class="form-control" name="vaccineDetails" placeholder="Enter Vaccine Detail"></textarea>
										</div>
									</div>
								</div>
							</section>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" name="months" class="form-control" placeholder="Enter Vaccine Month">
										</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" name="price" class="form-control" placeholder="Enter Vaccine Price">
										</div>

...
<body>
	...
	<div class="main-container">
			...
			<div class="pd-20 card-box mb-30" style="margin-left: 6rem;background: #fff;">
					<h3>View Upcoming Own Child Vaccines(next 30 days)</h3>
					<br>
	...
	for(Vaccine vac : vaccineList)
	{
			...
			LocalDate dateOfBirth=LocalDate.parse(child.getDob(),formatter);
	...
	%>
		...
		<tr>
			...
			<td><%=vac.getMonths()%></td>
			<td>Rs. <%=vac.getPrice()%></td>
			<td><%=vac.getVaccineDetails()%></td>
		</tr>
		<%}} %>

...
<body>
	...
	<div class="main-container">
		...
		<tr>
			...
			<td><%=v.getPrice()%></td>
			<td><%=v.getMonths()%></td>
			<td><a href="openUpdateVaccinePrice?vId=<%=v.getvId()%>&VaccineName=<%=v.getVaccineName()%>"><span class="badge badge-info">Update</span></a></td>
			<td><a href="deleteVaccine?vId=<%=v.getvId()%>"><span class="badge badge-danger">Delete</span></a></td>
		</tr>

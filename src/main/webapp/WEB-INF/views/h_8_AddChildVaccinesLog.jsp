		...
		<div class="pd-ltr-20 xs-pd-20-10" >
			<div class="min-height-200px" >
				...
				<div class="pd-20 card-box mb-30" style="background: #fff">
					<div class="clearfix">
						<h4 class="text-blue h4">Add Child Vaccine Log</h4>
						
					</div>
					<div class="wizard-content">
						<form class="tab-wizard wizard-circle wizard" action="AddVaccineLog" method="post">
							<h5>Child ID</h5>
							<section>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="childId" placeholder="Enter Child ID">
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<input class="form-control" name="vaccineName" placeholder="Enter Vaccine Name">
										</div>
									</div>
								</div>
							</section>
							...
							<section>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="number" class="form-control" name="ageMonths" placeholder="Enter Child Month">
										</div>
								...
								<div class="col-md-12 text-center">
									<button type="submit" class="btn btn-primary" style="background-color: #EF5A6F; color: white; border: none; padding: 10px 20px; cursor: pointer; margin: 0 0 20rem 48rem"
										...
										onmouseout="this.style.backgroundColor='#EF5A6F';">Add</button>
								</div>
							</div>
							</section>
						</form>

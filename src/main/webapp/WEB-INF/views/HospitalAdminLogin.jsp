...
<head>
	...
	<script>
	 ...
	 <style>
        ...
        /* Ensure the box doesn't affect body layout */
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7">
					<img src="./resources/vendors/images/bg3.avif" alt="" style="height: 27rem; width: 37rem">
				</div>
				<div class="col-md-6 col-lg-5" >
					<div class="login-box bg-white box-shadow border-radius-10" style="background-color: #f00;box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;">
						<div class="login-title">
							<h2 class="text-center text-primary" style="color:#028391">Hospital Admin Login</h2>
						</div>
